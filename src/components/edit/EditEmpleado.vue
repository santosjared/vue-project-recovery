            ...
            <div class="card-body">
                ...
                <form @submit.prevent="handleSubmit">
                    <div class="mb-3">
                        ...
                        <input type="text" id="nombre" class="form-control" v-model="formData.nombre" required
                            placeholder="Santos Machaca" />
                    ...
                    <div v-if="formData.area === 'Otro'" class="mb-3">
                        ...
                        <input type="text" id="otroArea" class="form-control" v-model="otroArea"
                            placeholder="Ing. Sistemas" required />
    ...
    methods: {
        ...
        handleSubmit() {
            if (this.validateForm()) {
                ...
                this.$store.dispatch('edit', { endpoint: '/empleados', data: this.formData, id:this.formData.id });
